...
<tr><td> <em>Generated: </em> 7/4/2023 11:59:48 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-450-M23/hw-html5-canvas-game/grade/mk42" target="_blank">Grading</a></td></tr></table>
...
<tr><td> <em>Response:</em> <p>I modified and edited the Pong game.<br></p><br></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://mk42-prod.herokuapp.com/M6/html5.html">https://mk42-prod.herokuapp.com/M6/html5.html</a> </td></tr>
<tr><td> <em>Sub-Task 3: </em> Add the pull request link for this assignment from M6-HTML5-Canvas to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/mohammad-kiyam/mk42-IT202-450/pull/24">https://github.com/mohammad-kiyam/mk42-IT202-450/pull/24</a> </td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>The first change is when a player scores more than 2 points, their<br>paddle become 50% larger.<br></p><br></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmk42%2F2023-07-05T03.47.23change1game.jpg.webp?alt=media&token=c8ca9a48-cab9-4c67-9ee0-5d89a07be9c1"/></td></tr>
<tr><td> <em>Caption:</em> <p>The paddle is now 1.5 time larger because the score is over 2<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmk42%2F2023-07-05T03.47.35change1code.jpg.webp?alt=media&token=53e8cec9-490d-42a0-822b-4108381d1269"/></td></tr>
<tr><td> <em>Caption:</em> <p>below the first if statement and below the else if statement I added<br>extra if statements where if score is greater than 2, than paddle become<br>1.5 times larger.<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td> <em>Sub-Task 1: </em> Describe your change/modification</td></tr>
<tr><td> <em>Response:</em> <p>If either score is greater than 4, then the ball will become 50%<br>larger.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Screenshot of the change while playing (try your best as some changes may be nearly impossible to capture)</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmk42%2F2023-07-05T03.48.27change2game.jpg.webp?alt=media&token=346d118c-630e-4463-a5b5-93d99250a239"/></td></tr>
<tr><td> <em>Caption:</em> <p>You can see that the ball is larger now that the score is<br>over 4<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 3: </em> Screenshot of the relevant lines of code that implement your change (make sure your ucid and the date are shown in comments) In the caption briefly describe/explain how the code snippet works.</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://firebasestorage.googleapis.com/v0/b/learn-e1de9.appspot.com/o/assignments%2Fmk42%2F2023-07-05T03.48.52change2code.jpg.webp?alt=media&token=7b711355-3dc0-42a5-908b-ccfd7bc1e97a"/></td></tr>
<tr><td> <em>Caption:</em> <p>If left side or right side score is greater than 4, then make<br>the ball height 50% larger.<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I learned that most games html games use the canvas feature which is<br>very interesting since I can now make my own games using that. Also<br>I learned about the pong logic while I was trying to make my<br>own changes. And using html for a more game focused style has let<br>me become more creative.<br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-450-M23/hw-html5-canvas-game/grade/mk42" target="_blank">Grading</a></td></tr></table>